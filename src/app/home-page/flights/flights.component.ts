...
headers = [ "Flight Number","Origination Date",
"Departure Station","Arrival Station","Latest DepartureTime",
"Latest ArrivalTime","Int-Or-Dom"];
...
// index = [ "flightNumber","originationDate",
// "departureStation","arrivalStation","latestDepartureTime",
// "latestArrivalTime","intOrDom"];

// flights : FlightRoutes[] = [];

// ngOnInit(): void {
//  this.rs.getFlightRoutes().subscribe
//  (
//    (response)=>
//    {
